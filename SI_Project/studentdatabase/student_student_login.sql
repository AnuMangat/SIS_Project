...
CREATE TABLE `student_login` (
  ...
  CONSTRAINT `student_id` FOREIGN KEY (`student_id`) REFERENCES `student_info` (`StudentID`) ON DELETE CASCADE
...
INSERT INTO `student_login` VALUES (4321,'Mike21'),(6789,'Nimo89');
...
-- Dump completed on 2020-10-18 12:52:58
