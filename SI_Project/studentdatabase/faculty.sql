...
(1000, 'Scott Goodwin', 'Computer Science'),
(1002, 'Xiaobu Yuan', 'Computer Science'),
(1004, 'Ryan Scott', 'Computer Science'),
(3003, 'Hugh Fackrell', 'Biology');
...
--
ALTER TABLE `faculty`
  MODIFY `FacultyID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3004;
COMMIT;
